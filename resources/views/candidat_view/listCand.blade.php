...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
                <h1 class="mb-4">Liste Candidat</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-3">
                                                    ...
                                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                                        <div class="rounded position-relative fruite-item">
                                                            <div class="fruite-img">
                                                               @if ($cand->photo)
                                                       <img src="{{asset('/storage/images/'.$cand->photo)}}" class="img-fluid w-100 rounded-top" alt="">
                                                    @endif
                                                            </div>
                                                            <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Candidat</div>
                                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                                <h4>{{$cand->prenom}} {{$cand->nom}}</h4>
                                                                <p>{{$cand->biographie}} Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                                    <p class="text-dark fs-5 fw-bold mb-0">Candidat</p>
                                                                    <a href="{{route('app_detailCand',['id' => $cand->id])}}" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-info-bag me-2 text-primary"></i>Detail</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script src="/frontElecteurlib/owlcarousel/owl.carousel.min.js"></script>
